  ...
  signupBtn.addEventListener('click', async (e) => {
    ...
    try {
      ...
      Swal.fire({
        icon: 'success',
        title: 'সফল!',
        html: 'আপনার অ্যাকাউন্ট তৈরি হয়েছে। <br>আপনার ইমেইলে একটি ভেরিফিকেশন লিঙ্ক পাঠানো হয়েছে। অনুগ্রহ করে ইমেইল ভেরিফাই করে লগইন করুন।ই-মেইল না পেলে  Spam বক্স চেক করুন। ',
